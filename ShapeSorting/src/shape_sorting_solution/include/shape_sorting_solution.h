/* Shape-sorting perception pipeline interface. */

#ifndef SHAPE_SORTING_SOLUTION_H_
#define SHAPE_SORTING_SOLUTION_H_
...
class ShapeSortingSolution
{
public:
  explicit ShapeSortingSolution(const rclcpp::Node::SharedPtr &node);
...
#endif  // SHAPE_SORTING_SOLUTION_H_
