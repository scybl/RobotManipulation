...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('task3_pick_offset_z', default_value='0.11'),
        ...
        DeclareLaunchArgument('task2_capture_dir', default_value='/tmp/pick_place_task2_capture'),
        ...
        Node(
            package='pick_place_solution',
            executable='pick_place_solution_node',
            name='pick_place_solution_node',
            output='screen',
            parameters=[{
                'use_sim_time': use_sim_time,
