/* Pick-and-place perception pipeline implementation. */
...
PickPlaceSolution::PickPlaceSolution(const rclcpp::Node::SharedPtr &node)
{
  node_ = node;
  ...
  t1_service_ = node_->create_service<cw1_world_spawner::srv::Task1Service>(
      "/task1_start",
      std::bind(&PickPlaceSolution::t1_callback, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, service_cb_group_);
  t2_service_ = node_->create_service<cw1_world_spawner::srv::Task2Service>(
      "/task2_start",
      std::bind(&PickPlaceSolution::t2_callback, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, service_cb_group_);
  t3_service_ = node_->create_service<cw1_world_spawner::srv::Task3Service>(
      "/task3_start",
      std::bind(&PickPlaceSolution::t3_callback, this, std::placeholders::_1, std::placeholders::_2),
      rmw_qos_profile_services_default, service_cb_group_);
  ...
  RCLCPP_INFO(node_->get_logger(), "PickPlace solution class initialised");
}

///////////////////////////////////////////////////////////////////////////////

void PickPlaceSolution::configure_arm_group(moveit::planning_interface::MoveGroupInterface &arm_group) const
{
...
geometry_msgs::msg::Pose PickPlaceSolution::make_top_down_pose(double x, double y, double z, double yaw) const
{
...
bool PickPlaceSolution::set_gripper_width(
...
bool PickPlaceSolution::move_arm_to_pose(
...
bool PickPlaceSolution::execute_cartesian_path(
    moveit::planning_interface::MoveGroupInterface &arm_group,
...
double PickPlaceSolution::get_current_finger_opening_width() const
{
  std::lock_guard<std::mutex> lock(joint_state_mutex_);
...
bool PickPlaceSolution::transform_pose_to_frame(
...
bool PickPlaceSolution::transform_point_to_frame(
...
void PickPlaceSolution::add_floor_collision_object() const
{
  moveit::planning_interface::PlanningSceneInterface planning_scene_interface;
  moveit_msgs::msg::CollisionObject floor;
  floor.id = "pick_place_floor";
...
void PickPlaceSolution::clear_collision_objects() const
{
  moveit::planning_interface::PlanningSceneInterface planning_scene_interface;
  planning_scene_interface.removeCollisionObjects({"pick_place_floor"});
}

bool PickPlaceSolution::execute_pick_and_place(
...
sensor_msgs::msg::PointCloud2::SharedPtr PickPlaceSolution::get_latest_cloud_copy() const
{
  std::lock_guard<std::mutex> lock(cloud_mutex_);
...
bool PickPlaceSolution::wait_for_cloud_update(
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr PickPlaceSolution::transform_latest_cloud(const std::string &target_frame)
{
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr PickPlaceSolution::scan_workspace(const std::string &target_frame)
{
  moveit::planning_interface::MoveGroupInterface arm_group(node_, "panda_arm");
  configure_arm_group(arm_group);
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr PickPlaceSolution::preprocess_cloud(
...
std::string PickPlaceSolution::classify_cluster_colour(
...
std::vector<PickPlaceSolution::DetectedObject> PickPlaceSolution::detect_objects(
...
void PickPlaceSolution::t1_callback(
...
void PickPlaceSolution::t2_callback(
...
void PickPlaceSolution::t3_callback(
